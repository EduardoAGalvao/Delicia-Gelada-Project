...
<html lang="pt-br">
  <head>
    ...
    <meta name="description" content="Página que apresenta as lojas do Delícia Gelada, incluindo sua localização."/>

    <title>Delícia Gelada - Lojas</title>
  ...
  <body>
    <div class="container center">
      ...
      <div id="container_principal" class="center">
        ...
        <!-- LOJAS -->
        <div id="div_lojas" class="center">
          
          <div id="background_lojas"></div>

          <div id="container_lojas" class="center">

            <div class="loja">
              <div class="loja_icone center"></div>
              <h2 class="loja_nome">Loja XPTO - Shopping ZZ</h2>
              <div class="localizacao_loja">
                <div class="localizacao_icone"></div>
                <div class="localizacao_descricao">
                  <p>Av. Luis Carlos Berrini, nº 666</p>
                  <p>Bairro Aleatório</p>
                  <p>Tel: +55(11)98783-9878</p>
                  <p>CEP: 09234-098 | Itapevi - SP</p>
                </div>
              </div>
            </div>
